...
import { Code, GitBranch, GitCommit, GitPullRequest, Clock, Zap, FolderGit, FileCode, Terminal, Coffee, Flame, BarChart3 } from 'lucide-react';
export default function DeveloperDashboard() {
    ...
    return (<div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-dark-800 rounded-xl p-6 border border-dark-700">
                    ...
                    <div className="space-y-3">
                        {languageStats.map((lang) => (<div key={lang.language} className="space-y-1">
                ...
                <div className="bg-dark-800 rounded-xl p-6 border border-dark-700">
                    ...
                    <div className="space-y-2">
                        {sessions.map((session) => (<div key={session.id} className="flex items-center justify-between p-3 bg-dark-900 rounded-lg">
                                <div className="flex items-center gap-3">
            ...
            return (<div key={day} className="flex-1 flex flex-col items-center gap-2">
                                <div className="w-full flex flex-col justify-end h-24">
                                    <div className={`w-full rounded-t-lg transition-all ${isToday ? 'bg-primary-500' : 'bg-primary-500/40'}`} style={{ height: `${height}%` }}/>
                                </div>
...
//# sourceMappingURL=DeveloperDashboard.js.map