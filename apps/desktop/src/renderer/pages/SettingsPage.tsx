...
import {
    ...
    Key, Save, Trash2, FolderOpen, Database, Download,
    Keyboard, Info, Shield, Zap, AlertTriangle, Plus, X,
    Cloud, LogOut, User, Check, Coffee, Palette, Target,
    Calendar, Lock, BarChart3, Volume2, Mic, Bot, TrendingUp, FileText
} from 'lucide-react';
                    ...
                    {activeSection === 'data' && (
                        <div className="space-y-4">
                            ...
                            <div className="bg-dark-800 rounded-xl border border-dark-700 p-4 space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm text-dark-400">Download focus data, sessions, and reports</div>
                                        </div>
                                    </div>
                                    <button
                                ...
                                <div className="grid grid-cols-3 gap-2 pt-4 border-t border-dark-700">
                                    <button className="flex flex-col items-center gap-2 p-3 bg-dark-700 hover:bg-dark-600 rounded-lg transition-colors">
                                        <FolderOpen className="w-5 h-5 text-blue-400" />
                                        <span className="text-xs text-dark-300">Focus Data</span>
                                    </button>
                                    <button className="flex flex-col items-center gap-2 p-3 bg-dark-700 hover:bg-dark-600 rounded-lg transition-colors">
                                        <BarChart3 className="w-5 h-5 text-green-400" />
                                        <span className="text-xs text-dark-300">Sessions</span>
                                    </button>
                                    <button className="flex flex-col items-center gap-2 p-3 bg-dark-700 hover:bg-dark-600 rounded-lg transition-colors">
                                        <FileText className="w-5 h-5 text-purple-400" />
                                        <span className="text-xs text-dark-300">Weekly Report</span>
                                    </button>
                                </div>
                            ...
                            <div className="p-4 bg-dark-800 rounded-xl border border-dark-700">
                                <div className="flex items-center gap-3 mb-3">
                                    <AlertTriangle className="w-5 h-5 text-yellow-400" />
                                    <span className="font-medium text-white">Your Data Privacy</span>
                                </div>
                                <p className="text-dark-400 text-sm">
                                    All productivity data is stored locally on your device. Cloud sync (if enabled) uses end-to-end encryption.
