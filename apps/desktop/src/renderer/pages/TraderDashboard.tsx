...
import {
    ...
    AlertTriangle, Activity, Calendar, Target,
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-xl font-medium transition-all ${isSessionActive
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <div className="text-center">
                            <input
                                ...
                                className="w-24 bg-dark-800 border border-dark-600 rounded px-2 py-1 text-center text-xl font-mono text-white"
                                placeholder="P&L"
                            />
                        ...
                        <div className="text-center">
                            <input
                                ...
                                className="w-16 bg-dark-800 border border-dark-600 rounded px-2 py-1 text-center text-xl font-mono text-white"
                            />
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-dark-800 rounded-xl p-6 border border-dark-700">
                    ...
                    {sessions.length === 0 ? (
                        <p className="text-dark-400 text-center py-8">No sessions yet</p>
                    ) : (
