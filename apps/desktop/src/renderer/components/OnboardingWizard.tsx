...
import {
    X, ChevronRight, ChevronLeft, Zap, Target, Brain,
    Clock, CheckCircle, Sparkles, Key, AlertTriangle
} from 'lucide-react';
...
export default function OnboardingWizard({ onComplete, onSkip }: OnboardingWizardProps) {
                ...
                <div className="text-center py-8">
                    ...
                    <div className="mt-8 grid grid-cols-3 gap-4">
                        {[
                            ...
                            <div key={label} className="p-4 bg-dark-700 rounded-xl">
                ...
                <div className="py-8">
                    ...
                    <div className="max-w-sm mx-auto space-y-4">
                        <button
                            ...
                            className={`w-full p-4 rounded-xl border transition-colors text-left ${autoTrack
    ...
    return (
        <div className="fixed inset-0 bg-dark-950/95 backdrop-blur-sm z-50 flex items-center justify-center p-6">
