...
export default function FocusQualityWidget({ score: propScore }) {
        ...
        if (propScore === undefined) {
            const loadStats = async () => {
                try {
                    ...
                    const calculatedScore = Math.min(100, Math.max(0, 50 + Math.floor(focusMinutes / 10) - (distractions * 5)));
            ...
            <div className="flex flex-col items-center py-4">
                ...
                <div className="relative w-32 h-32">
                    <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                        ...
                        {/* Progress circle */}
                        <circle cx="50" cy="50" r="45" fill="none" stroke="url(#scoreGradient)" strokeWidth="10" strokeDasharray={2 * Math.PI * 45} strokeDashoffset={2 * Math.PI * 45 * (1 - score / 100)} strokeLinecap="round" className="transition-all duration-1000"/>
                        <defs>
...
//# sourceMappingURL=FocusQualityWidget.js.map