            ...
            <div className="flex-1 overflow-auto space-y-2">
                {loading ? (
                    ...
                    tasks.map((task) => (
                        <div
                            key={task.id}
                            className={`flex items-center gap-3 p-3 rounded-lg bg-dark-900/50 group transition-all ${task.status === 'done' ? 'opacity-50' : ''
                                }`}
                        >
                            <button
                            ...
                            <button
                                ...
                                className="p-1 opacity-0 group-hover:opacity-100 text-dark-400 hover:text-red-400 transition-all"
                            >
