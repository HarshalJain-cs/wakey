...
export default function AIInsightsWidget() {
    ...
    return (<div className="widget-card h-full flex flex-col">
            <div className="widget-card-header">
                ...
                <button onClick={generateInsights} disabled={loading} className="p-1.5 rounded-lg bg-primary-500/10 text-primary-400 hover:bg-primary-500/20 transition-colors disabled:opacity-50">
            ...
            <div className="flex-1 space-y-3 overflow-auto">
                {loading ? (<div className="flex items-center justify-center py-8">
                    ...
                    </div>) : (insights.map((insight) => (<div key={insight.id} className={`p-3 rounded-lg border ${getInsightBg(insight.type)} flex items-start gap-3`}>
            ...
            <div className="pt-3 border-t border-dark-700 mt-3">
                <div className="flex gap-2">
                    <input type="text" value={prompt} onChange={(e) => setPrompt(e.target.value)} placeholder="Ask AI about productivity..." className="input-field flex-1 text-sm"/>
...
//# sourceMappingURL=AIInsightsWidget.js.map