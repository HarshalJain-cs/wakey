...
export default function GoalsWidget() {
    ...
    return (<div className="widget-card h-full">
            <div className="widget-card-header">
                ...
                {streak > 0 && (<div className="flex items-center gap-1 text-orange-400 bg-orange-500/20 px-2 py-1 rounded-full text-xs font-medium">
            ...
            return (<div key={goal.id} className="space-y-2">
                            ...
                            <div className="h-2 bg-dark-700 rounded-full overflow-hidden">
                                <div className={`h-full rounded-full transition-all duration-500 ${isComplete ? 'bg-green-500' : 'bg-primary-500'}`} style={{ width: `${progress}%` }}/>
                            </div>
                        </div>);
        })}
            </div>
...
//# sourceMappingURL=GoalsWidget.js.map