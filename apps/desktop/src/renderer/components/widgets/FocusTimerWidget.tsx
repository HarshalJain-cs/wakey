...
export default function FocusTimerWidget() {
    ...
    const selectDuration = useCallback((type: TimerState['sessionType']) => {
        setTimer(prev => ({
            ...prev,
            sessionType: type,
        ...
        <div className="widget-card h-full">
            ...
            <div className="flex flex-col items-center py-4">
                ...
                <div className="flex items-center gap-3 mt-6">
                    ...
                    <button
                        onClick={resetTimer}
                        className="p-3 rounded-full bg-dark-700 text-dark-400 hover:bg-dark-600 transition-all"
                    >
                ...
                <div className="flex items-center gap-2 mt-4">
                    {(['25', '30', '45', '60', '90'] as const).map((duration) => (
                        <button
                            key={duration}
