...
export default function DistractionAlert({ app, title, onDismiss, onBlock }: DistractionAlertProps) {
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 py-2 px-4 bg-dark-700 hover:bg-dark-600 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {countdown > 0 ? (
                                    <>
                            ...
                            <button
                                onClick={onBlock}
                                className="flex-1 py-2 px-4 bg-primary-500 hover:bg-primary-600 text-white rounded-lg transition-colors flex items-center justify-center gap-2"
                            >
