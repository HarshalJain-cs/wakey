...
import { reopenCookieConsent } from '@/components/effects/CookieConsent';
...
const footerLinks = {
  ...
  legal: [
    ...
    { name: 'Cookie Preferences', href: '#cookies', action: 'cookies' },
  ],
};
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center space-x-3" onClick={playClick}>
            ...
            <p className="mt-4 text-muted-foreground text-sm max-w-xs leading-relaxed">
              The productivity app that helps you focus, track progress, and achieve your goals with AI-powered insights.
            </p>
